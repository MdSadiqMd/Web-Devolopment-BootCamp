...
app.get("/", function (req, res) {
  ...
  res.render(path.join("C:/Users/Sadiq/Desktop/Web-Devolopment-BootCamp/NodeJS/_14_Guide_for_ejs/views/index.ejs"),{PORT:8000}); //The Variable PORT Given here acts as an prop in react as ejs converts the variable value while rendering // Remember in path we need to give ".ejs"
